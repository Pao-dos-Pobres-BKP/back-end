...
<!DOCTYPE html>
            ...
            <body>
                    <div class="header">
                            <img class="logo" src="assets/logo.png" alt="Company Logo" style="max-width: 150px; margin-bottom: 20px;">
                            <h2 class="email-header">${name}, seu código para recuperação de senha</h2>
                    </div>
                 <div class="message-container">
                            <div class="email-body">
                                    <p>Segue o seu código para recuperação de senha: ${code}.</p>
                                    <p>Use esse código no campo destinado, para autorizar a recuperação da senha.</p>
                            </div>
                            <div class="email-signature">
                                    Com carinho,
                                    <br>
